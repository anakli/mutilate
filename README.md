...
====================
    ...
    Basic options:
      -s, --server=STRING           Memcached server hostname[:port].  Repeat to
          ...
          --etcd                    Test etcd (0.4.6) instead of memcached.
          --http                    Test http instead of memcached.
    ...
    Advanced options:
      ...
      -W, --wait=INT                Time to wait after startup to start
                                      measurement.
          --lpause=INT              Time to wait after loading done before starting
                                      measurements.
          --save=STRING             Record latency samples to given file.
          --archive=STRING          Save all data to a given file.
          ...
          --linear                  Use linearizable reads for Etcd.
          --reserve=INT             Reserve this many slots in the sampling vector.
